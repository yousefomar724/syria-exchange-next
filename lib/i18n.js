        ...
        translation: {
          description: {
            ...
            PrivacyPolicy: {
              ...
              introText1:
                'At (Syria Exchange), we understand that the privacy of your personal information is important to you and us.',
              introText2:
                'Below is information about the types of personal information we receive and collect when you visit https://syria-exchange.com, How we protect your personal information. Log files As with most different websites, we collect and use the data contained in log files. The information in log files includes your Internet Protocol (IP) address, your Internet service provider (ISP), the browser you used to visit our site, The time you visited and the pages you visited on our website.',
              cookies: {
                title: 'Cookies:',
            ...
            UserAgreement: {
              ...
              introText:
                'By using the Syria Exchange website, you agree to be bound by the stipulated terms and conditions, so you should read and take these provisions into consideration:',
              condition1: {
        ...
        translation: {
          description: {
            ...
            UserAgreement: {
              ...
              introText:
                'من خلال استخدامك لموقع سوريا للصرافة فإنك توافق على الالتزام بالشروط والأحكام المنصوص عليها لذا يجب عليك الاطلاع على هذه الأحكام وأخدها بعين الاعتبار:',
              condition1: {
